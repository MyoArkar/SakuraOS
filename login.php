...
if(isset($_POST['sub']))
    { 
        if($_POST['email']=="" || $_POST['password']=="")
            ...
            {
                $d=$db->query("SELECT * FROM register where email='{$_POST['email']}' ");
                $row=$d->fetch();
                $fid=$row->email;
                $fpass=$row->password;
                ...
                header("location:order.php?img=$i&v=$v"); 
                }
                else 
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Logo End ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="index.php"><-Goback</a></li>
                            
                            <li class="scroll-to-section"><a href="index.php#reservation" >Register Here</a></li>
                        </ul>   
                    </nav>
                </div>
            </div>
                        ...
                        <form id="contact" action="" method="post">
                          <div class="row">
                           <div class="col-lg-12">
                            ...
                            <div class="col-lg-12" >
                              <h2 style="color:red; font-size:20px;"><?php echo $err;?></h2>
                            </div>
