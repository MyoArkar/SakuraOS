...
$type=$_POST['type'];
if($_POST['sub'])
{$qry="INSERT INTO $type(img,product,price)VALUES('$img','$prono','$price')";
$result=$db->query($qry) or die ("save items query fail.");
if($result)			
	   {mkdir("image");
                           ...
                           <div class="col-lg-12">
                            ...
                            <div class=" col-lg-12">
                                ...
                                <select value="type" name="type">
                                    ...
                                    <option value="kfood">Korean</option>
                                    <option value="jfood">Japanese</option>
                            ...
                            <div >
                                ...
                                <fieldset>
                                <input type="submit" name="sub" value="Insert" style="background: #fb5849;color: #fff;">
                                </fieldset>
                            </div>
